...
const Landing = () => {
  ...
  return (
    <div className='mx-16 flex flex-col items-center'>
      ...
      <img src="banner.png" alt="banner" className='w-250 my-11 md:px-11'/>

      <h2 className='my-8 text-4xl text-white text-center font-bold'>Frequently asked Questions (FAQs)</h2>

      <Accordion type="multiple" collapsible className="w-full sm:w-[90%] md:w-[80%] lg:w-[70%] mx-auto px-4 sm:px-6 md:px-11">
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-xl">How does Mini-Link works?</AccordionTrigger>
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="text-md">
            Yes, creating an account allows you to manage URLs, view analytics and customize your short URLs.
          </AccordionContent>
        </AccordionItem>
